...
public class Incident_Review_UnitMR_Test {
	...
	public void Incident_Review_UnitMR(String UserName,String Password,String SubUnit,String Department,String Contractor,String Area,String Shift,String ExactLocation,
			...
			String AuthorizationActionInvstegationUnitHEAD,String InvstegationUnitHEADComment) throws InterruptedException, AWTException
	{
		...
		//Comment
		driver.findElement(By.id("txtComment")).sendKeys(CommentUnitMR);
		Thread.sleep(1000);
