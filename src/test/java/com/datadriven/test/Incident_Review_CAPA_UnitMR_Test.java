...
import com.test.utility.Incident_Actions_Util;

public class Incident_Review_CAPA_UnitMR_Test {
	...
	public Iterator<Object[]> GetTestData()
	{
		...
		ArrayList<Object[]>testdata=Incident_Actions_Util.GetDataFromExcel();
		return testdata.iterator();
	}
	
	@Test(dataProvider="GetTestData",enabled=true)
	public void Incident_Review_CAPA_UnitMR(String UserName,String Password,String Clickonthat,String AuthorizationActionOperator,String OperatorComment,String Attachments,
			...
			String AuthorizationActionUnitMR,String UnitMRComment) throws InterruptedException
	{
		...
		Authorizationaction.selectByVisibleText(AuthorizationActionUnitMR);
		Thread.sleep(2000);
