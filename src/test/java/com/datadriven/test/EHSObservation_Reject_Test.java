...
public class EHSObservation_Reject_Test {
	WebDriver driver;
	...
	public void EHS_Observation_Review_DepartmentHead_AfetrTransfer_Reject(String DepartmentHeadUsername,String DepartmentHeadPassword,String Clickonthat,String AuthorizationAction,
	...
	{
		//Enter User name 
		driver.findElement(By.id("txtUserName")).sendKeys(TransferUsername);
		Thread.sleep(1000);
		//Enter Password
		driver.findElement(By.id("txtPassword")).sendKeys(TransferPassword);
		Thread.sleep(1000);
		//Click on submit
		...
		Authorizationaction.selectByVisibleText(TransferAuthorizationAction);
		Thread.sleep(2000);
		
		//Comment
		driver.findElement(By.id("txtComment")).sendKeys(Comment1);
		Thread.sleep(1000);
