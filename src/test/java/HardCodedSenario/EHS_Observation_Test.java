...
public class EHS_Observation_Test {
	...
	public void EHS_ObserVation_Report_operator() throws InterruptedException, AWTException
	{
		//Enter User name 
		...
		ObservationType.selectByVisibleText("Un-Safe Act");
		Thread.sleep(1000);
		
		//Observation Category 
		Select ObservationCategory = new Select(driver.findElement(By.id("ddlObservationCategory")));
		ObservationCategory.selectByVisibleText("Operating equipment without authority");
		Thread.sleep(1000);
...
//		Thread.sleep(1000);
	...
	public void EHS_Observation_Review_DepartmentHead() throws InterruptedException, AWTException
	{
		//Enter User name 
		...
		Authorizationaction.selectByVisibleText("Approve ");
		Thread.sleep(2000);
	...
	public void EHS_Observation_Review_DepartmentHead_Transfer() throws InterruptedException, AWTException
	{
		//Enter User name 
		driver.findElement(By.id("txtUserName")).sendKeys("demomathew");
		Thread.sleep(1000);
		...
		//Authorization Action
		Select Authorizationaction = new Select(driver.findElement(By.id("ddlAction")));
		Authorizationaction.selectByVisibleText("Transfer");
		Thread.sleep(2000);
		
				//Sub Unit 
				driver.findElement(By.id("txtSubUnit_value")).clear();
				Thread.sleep(1000);
				driver.findElement(By.id("txtSubUnit_value")).sendKeys("pvc");
				Thread.sleep(2000);
				...
				//Department/Function *
				driver.findElement(By.id("txtFunction_value")).sendKeys("pvc");
				Thread.sleep(2000);
				robot.keyPress(KeyEvent.VK_DOWN);
				Thread.sleep(2000);
				robot.keyPress(KeyEvent.VK_ENTER);
				...
				//Area 
				driver.findElement(By.id("txtLocation_value")).sendKeys("HOTLAB");
				Thread.sleep(2000);
				robot.keyPress(KeyEvent.VK_DOWN);
				Thread.sleep(2000);
				robot.keyPress(KeyEvent.VK_ENTER);
	...
	public void EHS_Observation_Review_DepartmentHead_AfetrTransfer_Reject() throws InterruptedException, AWTException
	{
		//Enter User name 
		driver.findElement(By.id("txtUserName")).sendKeys("demoravi");
		Thread.sleep(1000);
		//Enter Password
		driver.findElement(By.id("txtPassword")).sendKeys("admin");
		Thread.sleep(1000);
		...
		//Authorization Action
		Select Authorizationaction = new Select(driver.findElement(By.id("ddlAction")));
		Authorizationaction.selectByVisibleText("Send back for correct reporting");
		Thread.sleep(2000);
		
		//Comment
		driver.findElement(By.id("txtComment")).sendKeys("Test comment Reject");
		Thread.sleep(1000);
	...
	public void EHS_Observation_AfetrReject_Submit() throws InterruptedException, AWTException
	{
		//Enter User name 
		driver.findElement(By.id("txtUserName")).sendKeys("demogaurav007");
		Thread.sleep(1000);
	...
	public void EHS_Observation_Review_DepartmentHead_Discard() throws InterruptedException, AWTException
	{
		//Enter User name 
		driver.findElement(By.id("txtUserName")).sendKeys("demoravi");
		Thread.sleep(1000);
		...
		//Authorization Action
		Select Authorizationaction = new Select(driver.findElement(By.id("ddlAction")));
		Authorizationaction.selectByVisibleText("Not relevant / Irrelevant");
		Thread.sleep(2000);
		
		//Comment
		driver.findElement(By.id("txtComment")).sendKeys("Test comment Discard");
		Thread.sleep(1000);
