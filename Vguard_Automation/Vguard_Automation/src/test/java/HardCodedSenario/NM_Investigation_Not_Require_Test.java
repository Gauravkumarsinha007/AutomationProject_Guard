...
public class NM_Investigation_Not_Require_Test {
	...
	public void EHS_ObserVation_Report_NearMiss_operator() throws InterruptedException, AWTException
	{
		...
		driver.findElement(By.id("txtDescription")).sendKeys("Test Description Automation Near miss investigation not require full Test");
		Thread.sleep(1000);
