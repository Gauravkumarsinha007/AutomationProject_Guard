...
public class IIR_Test {
	...
	public void Report_Incident_operator() throws InterruptedException, AWTException
	{
		...
		driver.findElement(By.id("txtWhatHappenedDesc")).sendKeys("Test Desc for AT For IIR approve");
		Thread.sleep(1000);
...
//		Thread.sleep(1000);
	...
	public void Incident_Review_UnitMR() throws InterruptedException, AWTException
	{
		...
		//Authorization Action
		Select Authorizationaction = new Select(driver.findElement(By.id("ddlAction")));
		Authorizationaction.selectByVisibleText("Investigation not require");
		Thread.sleep(2000);
		
		//Comment
		driver.findElement(By.id("txtComment")).sendKeys("Investigation not require");
		Thread.sleep(3000);
	...
	public void Incident_Review_Reject() throws InterruptedException, AWTException
	{
		//Enter User name 
		driver.findElement(By.id("txtUserName")).sendKeys("demomathew");
		Thread.sleep(1000);
	...
	public void Incedent_AfetrReject_Submit() throws InterruptedException, AWTException
	{
		//Enter User name 
		driver.findElement(By.id("txtUserName")).sendKeys("demogaurav007");
		Thread.sleep(1000);
	...
	public void Incident_Review_DepartmentHead_Discard() throws InterruptedException, AWTException
	{
		//Enter User name 
		driver.findElement(By.id("txtUserName")).sendKeys("demomathew");
		Thread.sleep(1000);
