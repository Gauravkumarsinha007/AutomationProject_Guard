...
public class MeetingCompleted_Test {
	...
	public void Schedule_Meeting_CloseTest(String UserName,String Password,String MeetingType,String MeetingTopic,String MeetingVenue,String StartTime,String EndTime,String MeetingHost,
			...
			String cancelledcomment) throws InterruptedException, AWTException
	{
		...
		//Points
		driver.findElement(By.xpath("//input[@name='txtCheckListName']")).sendKeys(Meetingpoint);
		Thread.sleep(2000);
